    ...
    <section className="servicesAbout">
        <div className="container">
            <div className="servicesAbout__service" id="seo">
                ...
                <p style="text-align:left;">Search Engine Optimisation (SEO) is the process of improving the visibility of your website in Google’s organic search results, making it easier for your target audience to find you. It is a key component of any digital marketing strategy and when combined with PPC and content marketing, can yield great rewards for your company.</p>   
